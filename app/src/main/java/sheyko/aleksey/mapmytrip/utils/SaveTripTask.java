    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            builder.scheme("http")
                    ...
                    .appendQueryParameter("StateCd", "JH,BI,WB")
                    .appendQueryParameter("TotalStateDistanceTraveled", "20.5,30,50.5")
                    .appendQueryParameter("Total_State_Trip_Duration", "10,20,30")
